# This file is a slightly modified version of suber/hyp_to_ref_alignment/levenshtein_alignment.py, available as
# part of the SubER software: https://github.com/apptek/SubER under an Apache 2.0 LICENSE
...
# Dataclasses from suber.data_types
@dataclass
class Word:
    string: str
